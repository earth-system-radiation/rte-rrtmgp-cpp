...
nc_file.createDimension('x', ncol_x)
nc_file.createDimension('y', ncol_y)
...
nc_p_lay[:,:,:] = np.tile( nc_file_garand.variables['p_lay'][:,0][:,None], (1, ncol_y, ncol_x) )
nc_p_lev[:,:,:] = np.tile( nc_file_garand.variables['p_lev'][:,0][:,None], (1, ncol_y, ncol_x) )
...
nc_t_lay[:,:,:] = np.tile( nc_file_garand.variables['t_lay'][:,0][:,None], (1, ncol_y, ncol_x) )
nc_t_lev[:,:,:] = np.tile( nc_file_garand.variables['t_lev'][:,0][:,None], (1, ncol_y, ncol_x) )

# nc_col_dry = nc_file.createVariable('col_dry', float_type, ('lay', 'y', 'x'))
# nc_col_dry[:,:,:] = np.tile( nc_file_garand.variables['col_dry'][:,0][:,None], (1, ncol_y, ncol_x) )
...
nc_co2     = nc_file.createVariable('vmr_co2', float_type, ('lay', 'y', 'x'))
nc_o3      = nc_file.createVariable('vmr_o3' , float_type, ('lay', 'y', 'x'))
nc_n2o     = nc_file.createVariable('vmr_n2o', float_type, ('lay', 'y', 'x'))
nc_co      = nc_file.createVariable('vmr_co' , float_type, ('lay', 'y', 'x'))
nc_ch4     = nc_file.createVariable('vmr_ch4', float_type, ('lay', 'y', 'x'))
nc_o2      = nc_file.createVariable('vmr_o2' , float_type, ('lay', 'y', 'x'))
nc_n2      = nc_file.createVariable('vmr_n2' , float_type, ('lay', 'y', 'x'))

# Profiles
nc_h2o[:,:,:] = np.tile( nc_file_garand.variables['vmr_h2o'][:,0][:,None], (1, ncol_y, ncol_x) )
nc_co2[:,:,:] = np.tile( nc_file_garand.variables['vmr_co2'][:,0][:,None], (1, ncol_y, ncol_x) )
nc_o3 [:,:,:] = np.tile( nc_file_garand.variables['vmr_o3' ][:,0][:,None], (1, ncol_y, ncol_x) )
nc_n2o[:,:,:] = np.tile( nc_file_garand.variables['vmr_n2o'][:,0][:,None], (1, ncol_y, ncol_x) )
nc_co [:,:,:] = np.tile( nc_file_garand.variables['vmr_co' ][:,0][:,None], (1, ncol_y, ncol_x) )
nc_ch4[:,:,:] = np.tile( nc_file_garand.variables['vmr_ch4'][:,0][:,None], (1, ncol_y, ncol_x) )
nc_o2 [:,:,:] = np.tile( nc_file_garand.variables['vmr_o2' ][:,0][:,None], (1, ncol_y, ncol_x) )
nc_n2 [:,:,:] = np.tile( nc_file_garand.variables['vmr_n2' ][:,0][:,None], (1, ncol_y, ncol_x) )
...
cloud_flag = (np.arange(1, ncol_x+1)%3 > 0)

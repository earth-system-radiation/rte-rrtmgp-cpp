...
Netcdf_group::Netcdf_group(const int ncid_in, const int root_ncid_in) :
    Netcdf_handle()
{
    ncid = ncid_in;
...
template<typename T>
Netcdf_variable<T>::Netcdf_variable(Netcdf_handle& nc_file, const int var_id, const std::vector<int>& dim_sizes) :

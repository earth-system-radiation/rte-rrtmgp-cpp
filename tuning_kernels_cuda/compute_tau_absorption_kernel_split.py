...
def tune():
    ...
    params_minor = dict()
    params_minor["block_size_x"] = [1,2,4,8,12,16]
    params_minor["block_size_y"] = [1,2,4,8,12,16]
...
if __name__ == "__main__":
    ...
    kernel_name_minor = 'compute_tau_minor_absorption_kernel_split<{}>'.format(str_float)
